...
/**
 * Servlet implementation class DeleteBookMember
 */
@WebServlet("/DeleteBookMember")
public class DeleteBookMember extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DeleteBookMember() {
        super();
	...
	//	ProductBean productBean;
		...
		if(num == 1){
			...
			out.println(" <body>");
			out.println(
			" <script>alert('ไม่สำเร็จ');window.location='DeleteProductAdmin.jsp';</script>");
			out.println(" </body>");
			out.println("</html>");
