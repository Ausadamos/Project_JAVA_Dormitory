...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.2.3/js/dataTables.buttons.min.js">
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.2.3/js/buttons.bootstrap.min.js">



<link rel="stylesheet" href="
https://cdn.datatables.net/1.10.13/css/dataTables.bootstrap.min.css">
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.2.3/css/buttons.bootstrap.min.css">
...
<a href="indexAdmin.jsp">กลับหน้าหลัก</a>
...
<table cellspacing="0" table border="1"
				...
				<tr>
					...
					<td><%=room.getFirstname()%></td>
					<td><%=room.getLastname()%></td>
					<td><%=room.getRoomtype()%></td> <!--  -->
					<td><%=room.getStutus_book()%></td>
					<td><%=room.getStutus_payBook()%></td>
					<td><%=room.getBookDate()%></td><!--  -->
					<td><%=room.getDateCheckIn()%></td>
					<td><%=room.getDateCheckOut()%></td><!--  -->
					<td><%=room.getBookType()%></td>
					<td><%=room.getPeople()%></td><!--  -->
					<td><%=room.getNameType()%></td>
